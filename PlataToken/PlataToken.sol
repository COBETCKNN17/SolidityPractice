...
contract PlataToken is MintableToken {
    // Define 3 public state variables: name, symbol, number of decimals.
    string public constant name = "PlataToken"; // solium-disable-line uppercase
    string public constant symbol = "PLT"; // solium-disable-line uppercase
